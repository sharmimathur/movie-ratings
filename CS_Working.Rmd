...
genre_df <- data.frame(movies$Title, movies$Total.Gross, movies$Score_Audience, movies$Score_Rotten, movies$average_rating, movies$genre1, movies$genre2, movies$genre3, movies$genre)
...
genre_filtered <- genre_df %>% filter(gross>20000000)
