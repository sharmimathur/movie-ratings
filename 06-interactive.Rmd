...
svg.selectAll("dot")
   ...
   .enter().append("circle")
     ...
     .on("mouseout", function(d) {
      ...
      var i=0;
      var studios = ["Lionsgate","Paramount Pictures","Sony Pictures Entertainment (SPE)",
      "The Weinstein Company","Twentieth Century Fox","Universal Pictures",
      "Walt Disney Studios Motion Pictures","Warner Bros."]
//   data.forEach(function(d) {
//       console.log(studios[i]);
//       console.log(d[studios[i]]);
//     svg.append("text")
//     .attr("transform", "translate(" + (width+3) + "," + y(d[studios[i]]) + ")")
//     .attr("dy", ".35em")
...
//   });
    ...
    // svg.selectAll('line').append("text")
    //     .attr("class","label")
    //     .datum(function(d) {
    //         console.log(d);
    //         return {
